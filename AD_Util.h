...
public:
     ...
     */
    float find_Exposure_Adjustment(std::stack<Mat> frames);
    /**
     ...
     *      the adjustment it needs to make to current exposure
     */
    float find_Temperature_Adjustment(std::stack<Mat> frames);
    /**
     ...
     */
    HSVRange find_Red_HSVRange(std::stack<Mat> frames);
    /**
